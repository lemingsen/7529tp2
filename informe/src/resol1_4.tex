...
\begin{figure}[H]
    \centering
    \subcaptionbox
        {\label{fig:GrafoH_minimos1}\textbf{Caminos mínmos desde V\textsubscript{1}}.}
        {\includegraphics[width=0.4\linewidth,angle=0,origin=c]{out/caminos/camino1.png}}
    \subcaptionbox
        {\label{fig:GrafoH_minimos2}\textbf{Caminos mínmos desde V\textsubscript{2}}.}
        {\includegraphics[width=0.4\linewidth,angle=0,origin=c]{out/caminos/camino2.png}}
    \subcaptionbox
        {\label{fig:GrafoH_minimos3}\textbf{Caminos mínmos desde V\textsubscript{3}}.}
        {\includegraphics[width=0.4\linewidth,angle=0,origin=c]{out/caminos/camino3.png}}
    \subcaptionbox
        {\label{fig:GrafoH_minimos4}\textbf{Caminos mínmos desde V\textsubscript{4}}.}
        {\includegraphics[width=0.4\linewidth,angle=0,origin=c]{out/caminos/camino4.png}}
    \subcaptionbox
        {\label{fig:GrafoH_minimos5}\textbf{Caminos mínmos desde V\textsubscript{5}}.}
        {\includegraphics[width=0.4\linewidth,angle=0,origin=c]{out/caminos/camino5.png}}
    \caption{\label{fig:GrafoH_minimos}\textbf{Grafo $H$} con caminos mínimos (en verde, junto con la distancia) según el punto de origen.}
\end{figure}
