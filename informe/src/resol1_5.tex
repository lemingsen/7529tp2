...
\begin{table}[H]
    ...
    \toprule
                                                                                      & \multicolumn{3}{c}{1ª iteración}                                                                                 & \multicolumn{2}{c}{V\_1} & \multicolumn{2}{c}{V\_2}                                                  & \multicolumn{2}{c}{V\_3}                                                  & \multicolumn{2}{c}{V\_4} & \multicolumn{2}{c}{V\_5} & \multicolumn{3}{c}{2ª iteración} &                              \\ \cmidrule(lr){2-17}
    \multirow{-2}{*}{\begin{tabular}[c]{@{}c@{}}Fórmula\\ posible nuevo\end{tabular}}&Nuevo&$\lesseqgtr$& Ant. & h &    p   & h                           & p                             & h                           & p                                    & h & p      & h & p    & Nuevo     & $\lesseqgtr$              & Ant. & \multirow{-2}{*}{Resultados} \\ \cmidrule(r){1-1} \cmidrule(l){18-18} 
    $0\rightarrow 1 \dots 0\rightarrow 5$   & {\color[HTML]{9A0000} $0+0$} & $<$ & 0                           & 0 & $V_0$ & 0                           & $V_0$                        & 0                           & $V_0$                               & 0 & $V_0$ & 0 & $V_0$ & $0+0$     & $\leq$   & h(x) & Sin cambios                  \\
